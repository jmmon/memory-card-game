...
import { INITIAL_STATE, INITIAL_USER_SETTINGS } from "~/v3/context/initialState";
...
export default component$(({ settings }: { settings: iUserSettings }) => {
  console.log('game component:', { settings });
