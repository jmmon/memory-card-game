  ...
  return (
    <>
      {MatchModalStore.modal.isShowing && (
        <div class="backdrop-blur-sm bg-black bg-opacity-10 w-screen h-screen absolute top-0 left-0 flex flex-col justify-center items-center z-[1000]">
          <div class="bg-amber-100 p-4 gap-4 w-4/12 h-1/3 border-2 rounded-2xl border-zinc-500 flex flex-col justify-center items-center">
            ...
            <p class="text-blue-900"><code>{MatchModalStore.modal.text}</code></p>
            <p>press esc to close modal</p>
          </div>
        </div>
      )}
    </>
