import { CARD_RATIO } from "../v3-board/v3-board";
import type { BoardLayout, CardLayout, Pair, V3Card } from "../v3-game/v3-game";
...
function checkMatch(cardA: V3Card | undefined, cardB: V3Card | undefined) {
...
function findCardById(cards: V3Card[], id: number) {
