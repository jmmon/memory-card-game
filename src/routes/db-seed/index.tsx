...
export const onRequest: RequestHandler = ({ env, redirect }) => {
  console.log(
    "redirect: isScoresEnabled:",
    env.get("WRANGLER_FEATURE_FLAG_SCORES_ENABLED") === "true",
    "redirect: isScoresSeedEnabled:",
    env.get("WRANGLER_FEATURE_FLAG_SCORES_SEED_ENABLED") === "true",
  );
  if (
    env.get("WRANGLER_FEATURE_FLAG_SCORES_ENABLED") !== "true" ||
      env.get("WRANGLER_FEATURE_FLAG_SCORES_SEED_ENABLED") !== "true"
